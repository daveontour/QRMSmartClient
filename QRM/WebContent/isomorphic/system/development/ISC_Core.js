...
);isc.evalBoundary;isc.B.push(isc.A.$v7=function isc_Canvas__setPeersOpacity(_1,_2,_3){if(!this.peers)return;for(var i=0;i<this.peers.length;i++){if(this.peers[i].$nt){if(this.useOpacityFilter!=null){this.peers[i].useOpacityFilter=this.useOpacityFilter}
...
_7=unescape(_7);_7=_7.replace(this.slashMarker,"/");_5[_9]=_7}
